  ...
  return (
    ...
    className="w-full flex xl:flex-row flex-col justify-center  min-h-screen gap-10 max-container">
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
        <p className="text-cl font-montserrat text-coral-red text-xl">Our Summer Collection</p>
        ...
        <Button label='Shop now' iconURL={arrow}/>
      ...
      <div className="relative flex flex-1 justify-center items-center xl:min-h-screen max-xl:py-40 bg-primary bg-hero">
            ...
            />
            <div className="flex sm:gap-6 gap-4 absolute -bottom-[3.5%] sm:left-[10%] max-sm:px-6">
              {shoes.map((shoe)=>(
                <div key={shoe}>
                    <ShoeCard
                    imageURL={shoe}
